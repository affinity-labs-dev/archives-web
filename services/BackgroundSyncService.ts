...
class BackgroundSyncService {
  ...
  async syncAdventureProgress() {
    const operation = async () => {
      ...
      const adventureData = await AsyncStorage.getItem(STORAGE_KEYS.ADVENTURE_PROGRESS);
  ...
  async syncModuleProgress() {
    const operation = async () => {
      ...
      const moduleData = await AsyncStorage.getItem(STORAGE_KEYS.MODULE_PROGRESS);
