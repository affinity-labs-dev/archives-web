...
/**
 * Screen — Signup (email + password + first/last name).
 *
 * Figma: 3645:5412. Cloned from `/(auth)/email-details.tsx` with the signup
 * logic isolated — no mode toggle state, the Log In button navigates to the
 * login screen. Clerk `useSignUp` + validation + error mapping preserved.
 *
 * Entrance sequence (100ms field stagger):
 *   t=0    title "COMPLETE PROFILE"
 *   t=150  toggle row
 *   t=300  first/last name row
 *   t=400  email
 *   t=500  password
 *   t=600  confirm password
 *   t=900  CONTINUE button
 */
