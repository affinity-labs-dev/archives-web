// ROIERA2Adv1_Module2_Lesson1.tsx - Rise of Islam Era 2: Adventure 1 Module 2 Lesson 1
// "Muhammad Al-Amin - The Trustworthy One" - Video + Reading lesson with exact VideoReadingLesson.md compliance
...
interface ROIERA2Adv1_Module2_Lesson1Props {
  onContinue: () => void;    // Required: Navigation to next lesson
  onDismiss: () => void;     // Required: Close lesson modal
}

export default function ROIERA2Adv1_Module2_Lesson1({
  onContinue,
  onDismiss,
}: ROIERA2Adv1_Module2_Lesson1Props) {
  ...
  // Historical content for Rise of Islam Era - Muhammad Al-Amin
  const historicalText = `Even before he received revelation, Muhammad ﷺ was known for his honesty and kindness toward those in need. People called him "Al-Amin," meaning the Trustworthy. He refused to take part in the corruption and unfairness around him. Later, the Qur'an spoke out clearly against these wrongs, saying, "Woe to those who push away the orphan…" and calling for mercy, justice, and fairness in society.`;
  ...
  const handleContinue = async () => {
    ...
    console.log("🔄 Continue button pressed - ROI_Adv1_M2 Lesson 1 completed, proceeding to lesson 2");
    onContinue();
  };
              ...
              <View style={styles.expandedContentInner}>
                ...
                <View style={styles.titleSection}>
                  <Text style={styles.sheetTitle}>
                    Muhammad Al-Amin - The Trustworthy One
                  </Text>
                ...
                <View style={styles.keyTermsSection}>
                  ...
                  <View style={styles.keyTermsContainer}>
                    <KeyTermRow
                      term="Al-Amin"
                      definition="'The Trustworthy' - the title given to Muhammad ﷺ by the people of Mecca before his prophethood due to his honesty and reliability"
                    />
                    <KeyTermRow
                      term="Social Justice"
                      definition="The Qur'anic principle of fair treatment, mercy, and protection of the vulnerable in society, especially orphans and the poor"
                    />
                    <KeyTermRow
                      term="Pre-Islamic Corruption"
                      definition="The widespread unfairness and exploitation in Meccan society before Islam, which Muhammad ﷺ refused to participate in"
                    />
                  </View>
                </View>
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        <LessonPlayer
          videoSource={{ uri: "http://d3bi5e5vkj68.cloudfront.net/Reels/ROI_Adv1_M2_Reel1.mp4" }}
