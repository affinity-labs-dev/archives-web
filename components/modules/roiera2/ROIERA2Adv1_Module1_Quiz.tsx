...
export default function ROIERA2Adv1_Module1_Quiz({
  ...
  const [selectedFillBlank, setSelectedFillBlank] = useState<string | null>(
    null
  );
            ...
            <View style={styles.fillBlankOptionsGrid}>
              {currentQuestion.options?.map((option, index) => (
                <FillBlankOption
                  ...
                  text={option}
                  isUsed={
                    fillBlankOptions.find((opt) => opt.text === option)
                      ?.isUsed || false
                  }
            ...
            {canAccessAdventure ? (
              ...
              <View style={styles.lockedContainer}>
                ...
                <Text style={styles.lockedMessage}>
                  Answer at least 2 questions correctly (40% minimum) to unlock
                  the adventure
                </Text>
              </View>
            )}
    ...
    <View style={styles.alertOverlay}>
      ...
      >
        ...
        <Text style={styles.alertMessage}>
          You need to answer at least 2 questions correctly (40% minimum) to
          complete the quiz and unlock the adventure.
        </Text>
...
const styles = StyleSheet.create({
  ...
  fillBlankOptionsGrid: {
    ...
    flexWrap: "wrap",
    justifyContent: "center",
    paddingHorizontal: 20, // Reduced padding for 2x2 grid
    paddingTop: 5, // Minimal spacing between question and options
    maxWidth: 380, // Increased to accommodate 2 buttons per row
    alignSelf: "center",
  },
