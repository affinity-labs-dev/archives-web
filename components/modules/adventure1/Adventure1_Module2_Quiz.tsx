// Adventure1_Module2_Quiz.tsx - EXACT replica of SwiftUI Adventure1_Module2_Quiz.swift
// 5-question quiz with MCQ + explanations and results
...
interface Adventure1_Module2_QuizProps {
  onDismiss: () => void
  onBack?: () => void
}

// Quiz Data - Module 2: Court & Administration
const quizQuestions = [
  {
    question: "The throne room walls were covered with what shiny art?",
    correctAnswer: 0, // A) Gold mosaic tiles
    explanation: "The Umayyad palace throne rooms featured elaborate gold mosaic tiles that demonstrated the wealth and power of the caliphate, creating a magnificent setting for royal ceremonies.",
    points: 10,
    type: 'mcq' as const,
    options: ["Gold mosaic tiles", "Plain red bricks"],
    image: require('@/assets/images/quiz-images/mosque.png')
  },
  {
    question: "Who helped the caliph run the empire each day?",
    correctAnswer: 0, // A) Wazir
    explanation: "The Wazir served as the chief minister and advisor to the caliph, helping manage the day-to-day administration of the vast Umayyad empire.",
    points: 10,
    type: 'mcq' as const,
    options: ["Wazir", "Qadi", "Scribe", "Guard"],
    image: require('@/assets/images/quiz-images/Reader.png')
  },
  {
    question: "What job was done in the palace scriptorium?",
    correctAnswer: 1, // B) Scribes copied papers
    explanation: "The palace scriptorium was where skilled scribes copied important documents, letters, and administrative records that kept the empire functioning.",
    points: 10,
    type: 'mcq' as const,
    options: ["Soldiers practiced drills", "Scribes copied papers"],
    image: require('@/assets/images/quiz-images/writer.png')
  },
  {
    question: "Court talks often used Arabic, Greek, and which other language?",
    correctAnswer: 0, // A) Syriac
    explanation: "The Umayyad court was multilingual, conducting business in Arabic, Greek, and Syriac to communicate with the diverse populations across the empire.",
    points: 10,
    type: 'mcq' as const,
    options: ["Syriac", "Latin", "Sanskrit"],
    image: require('@/assets/images/quiz-images/Bilingual.png')
  },
  {
    question: "People said the palace felt like both a _______ and a _______.",
    correctAnswer: 0, // A) Fortress and safe place
    explanation: "The Umayyad palace combined defensive military architecture with comfortable living spaces, making it feel like both a fortress for protection and a safe place for daily life.",
    points: 10,
    type: 'mcq' as const,
    options: ["Fortress and safe place", "Farm and workshop", "Library and theater", "Shop and stable"],
    image: require('@/assets/images/quiz-images/Map.png')
  }
]

export default function Adventure1_Module2_Quiz({ onDismiss, onBack }: Adventure1_Module2_QuizProps) {
  ...
  const [fillBlankOptions, setFillBlankOptions] = useState([
    { text: "Fortress", isUsed: false },
    { text: "Safe place", isUsed: false },
    { text: "Library", isUsed: false },
  ...
  return (
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        {/* Minimum score alert - EXACT SwiftUI: Adventure1Module2MinimumScoreAlertView */}
...
// Quiz Results View - EXACT SwiftUI Adventure1Module2QuizResultsView
...
const styles = StyleSheet.create({
  ...
  // Results View - EXACT SwiftUI Adventure1Module2QuizResultsView
  resultsContainer: {
    flex: 1,
