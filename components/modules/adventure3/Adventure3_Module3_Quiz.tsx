// Adventure3_Module3_Quiz.tsx - EXACT replica of SwiftUI Adventure3_Module3_Quiz.swift
// 5-question quiz about Battle of Tours aftermath and cultural exchange
...
interface Adventure3_Module3_QuizProps {
  onDismiss: () => void
  onBack?: () => void
}
...
// Quiz Data - Module 3 questions about Battle of Tours aftermath and cultural exchange
const quizQuestions: QuizQuestionData[] = [
  {
    question: "In what year did the Umayyad and Frankish armies fight near Tours?",
    correctAnswer: 2, // C) 732 CE
    explanation: "The Battle of Tours took place in 732 CE, when Charles Martel's Frankish forces defeated the Umayyad army, marking the end of Islamic expansion into northern Europe.",
    points: 10,
    type: 'mcq' as const,
    options: ["700 CE", "721 CE", "732 CE", "800 CE"],
    image: require('@/assets/images/quiz-images/Map.png')
  },
  {
    question: "Who led the Frankish soldiers in the battle?",
    correctAnswer: 1, // B) Charles Martel
    explanation: "Charles Martel led the Frankish forces at the Battle of Tours. His victory earned him the nickname 'The Hammer' and established his reputation as a defender of Christian Europe.",
    points: 10,
    type: 'mcq' as const,
    options: ["Louis", "Charles Martel"],
    image: require('@/assets/images/quiz-images/navigation.png')
  },
  {
    question: "What was the main result of the battle for Umayyad expansion into northern Europe?",
    correctAnswer: 0, // A) It stopped further advance
    explanation: "The Battle of Tours effectively stopped Umayyad expansion into northern Europe. While they retained control of al-Andalus, their ambitions to conquer Frankish territories came to an end.",
    points: 10,
    type: 'mcq' as const,
    options: ["It stopped further advance", "It sped up conquest", "They captured Paris", "Nothing changed"],
    image: require('@/assets/images/quiz-images/ship.png')
  },
  {
    question: "The battle took place close to which modern French city?",
    correctAnswer: 3, // D) Tours
    explanation: "The battle took place near Tours, a city in central France. This gave the battle its name and marked the northernmost point of Islamic expansion in Western Europe.",
    points: 10,
    type: 'mcq' as const,
    options: ["Paris", "Lyon", "Bordeaux", "Tours"],
    image: require('@/assets/images/quiz-images/scroll.png')
  },
  {
    question: "After the battle, did the Umayyad forces still control al-Andalus?",
    correctAnswer: 0, // A) Yes  
    explanation: "Yes. Although the Umayyads were defeated at Tours, they continued to control al-Andalus (Islamic Spain) for centuries afterwards. The battle only stopped their expansion into northern Europe.",
    points: 10,
...
export default function Adventure3_Module3_Quiz({ onDismiss, onBack }: Adventure3_Module3_QuizProps) {
  ...
  const handleQuizCompletion = async () => {
    console.log('🚀 Quiz completion: Adventure 3 Module 3')

    try {
      const isRetake = canRetakeModule(3, 3)

      // Use atomic progress update
      await atomicProgressUpdate(3, 3, {
  ...
  const renderQuestionContent = () => {
    if (currentQuestion.type === 'mcq') {
      // Questions 1, 2 & 4 (index 0, 1 & 3) should be center-aligned, Q3 left-aligned
      const shouldCenter = currentQuestionIndex === 0 || currentQuestionIndex === 1 || currentQuestionIndex === 3
        ...
        <View style={styles.mcqContainer}>
          {currentQuestion.options?.map((option, index) => (
            <MCQOptionButton
              ...
              forceCenter={shouldCenter} // Q1 center-aligned, others left-aligned
            />
          ))}
        </View>
      )
  ...
  return (
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        {/* Minimum score alert - EXACT SwiftUI: Adventure3Module3MinimumScoreAlertView */}
...
function QuizResultsView({
  ...
  const passed = percentage >= 40 // EXACT SwiftUI: private var passed: Bool (40% for Module 3)
            ...
            {canAccessAdventure ? (
              ...
              <View style={styles.lockedContainer}>
                ...
                <Text style={styles.lockedMessage}>
                  Answer at least one question correctly to complete the module
                </Text>
              </View>
            )}
          </View>
    ...
    <View style={styles.alertOverlay}>
      <Animated.View style={[styles.alertCard, { transform: [{ scale: scaleAnim }] }]}>
        ...
        <Text style={styles.alertMessage}>
          You need to answer at least one question correctly to complete the quiz and unlock the next adventure.
        </Text>
...
const styles = StyleSheet.create({
  ...
  // Results View - EXACT SwiftUI Module3QuizResultsView
  resultsContainer: {
    flex: 1,
