// Adventure3_Module1_Lesson2.tsx - EXACT replica of Adventure1_Module1_Lesson1 structure
...
interface Adventure3_Module1_Lesson2Props {
  onContinue: () => void;
  onDismiss: () => void;
  onBack?: () => void;
}

export default function Adventure3_Module1_Lesson2({
  onContinue,
  onDismiss,
  onBack,
  ...
  const {
    ...
    lessonTitle: "Kairouan: From Military Camp to Cultural Center",
    chapterNumber: 1,
    screenUrl: '/adventure/3/module/1/lesson2'
  });
  ...
  const handlePlaybackStatusUpdate = (status: AVPlaybackStatus) => {
    if (status.isLoaded) {
      if (!isVideoLoaded) {
        ...
        console.log(
          "🎬 DEBUG: Adventure3_Module1_Lesson2 video player ready - starting playback"
        );
      }
