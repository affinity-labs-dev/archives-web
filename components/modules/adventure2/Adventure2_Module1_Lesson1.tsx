// Adventure2_Module1_Lesson1.tsx - Administrative Language Carousel
// Full-screen image carousel showing language transition scenes
...
interface Adventure2_Module1_Lesson1Props {
  onContinue: () => void;
  onDismiss: () => void;
  onBack?: () => void;
}

// Language scene data with AWS CloudFront assets
const languageScenes = [
  {
    id: 1,
...
export default function Adventure2_Module1_Lesson1({
  onContinue,
  onDismiss,
  onBack,
}: Adventure2_Module1_Lesson1Props) {
  ...
  useEffect(() => {
    ...
    console.log(`🎵 [${timestamp}] Adventure2_Module1_Lesson1 - Background music state:`, {
  ...
  useEffect(() => {
    ...
    const startBackgroundMusic = async () => {
      ...
      if (backgroundMusic.isLoaded && !backgroundMusic.isPlaying) {
        console.log(`🎵 [${timestamp}] Starting administrative language background music`);
      ...
      <View style={styles.container}>
        ...
        >
          {languageScenes.map((scene, index) => (
            <View key={scene.id} style={styles.imageContainer}>
              {/* Full screen language scene image */}
              <Image 
        ...
        <SafeAreaView style={styles.continueButtonContainer}>
          ...
          >
            <Ionicons 
              ...
              size={24} 
              color={currentImageIndex === languageScenes.length - 1 ? "white" : "#666"} 
            />
          </TouchableOpacity>
        </SafeAreaView>
