// Adventure2_Module1_Quiz.tsx - EXACT replica of SwiftUI Adventure2_Module1_Quiz.swift
// 5-question quiz about Abd al-Malik's administrative language reforms
...
interface Adventure2_Module1_QuizProps {
  onDismiss: () => void
  onBack?: () => void
}

// Quiz Data - Module 1 questions about Abd al-Malik's administrative language reforms
const quizQuestions = [
  {
    question: "Which caliph made Arabic the language of government?",
    correctAnswer: 1, // B) Abd al-Malik
    ...
    points: 10,
    type: 'mcq' as const,
    options: ["Muawiya", "Abd al-Malik", "Yazid", "Marwan"],
    image: require('@/assets/images/quiz-images/Reader.png')
  },
  {
    question: "Arabic replaced Greek and Persian in official papers.",
    correctAnswer: 0, // True
    explanation: "True. Under Abd al-Malik's reforms, Arabic replaced both Greek and Persian languages in official government documents and administration.",
    points: 10,
    type: 'trueFalse' as const,
    image: require('@/assets/images/quiz-images/Map.png')
  },
  {
    question: "Before the change, which of these languages was not common in government scrolls?",
    correctAnswer: 3, // D) Latin
    explanation: "Latin was not commonly used in government scrolls in the Umayyad territories. Greek and Persian were the main administrative languages before Arabic.",
    points: 10,
    type: 'mcq' as const,
    options: ["Greek", "Persian", "Syriac", "Latin"],
    image: require('@/assets/images/quiz-images/books.png')
  },
  {
    question: "Did some local governors fight the language switch?",
    correctAnswer: 0, // True (Yes)
    explanation: "True. Some local governors resisted the language change as it required retraining staff and disrupted established administrative practices.",
    points: 10,
    type: 'trueFalse' as const,
    image: require('@/assets/images/quiz-images/Reader.png')
  },
  {
    question: "The word diwān refers to a…",
    correctAnswer: 2, // C) Government office
    explanation: "Diwān refers to a government office or administrative department in the Islamic empire, central to the bureaucratic system.",
    points: 10,
    type: 'mcq' as const,
    options: ["Palace", "Market", "Government office", "Mosque"],
    image: require('@/assets/images/quiz-images/Map.png')
  }
]

export default function Adventure2_Module1_Quiz({ onDismiss, onBack }: Adventure2_Module1_QuizProps) {
  ...
  console.log('🚀 DEBUG: Adventure2_Module1_Quiz appeared')
  ...
  const handleGoToAdventure = () => {
    console.log('🚀 DEBUG: Go to Adventure button pressed in Adventure2_Module1_Quiz')
    console.log('🚀 DEBUG: Setting adv2_mod1 completion to true')
    
    // Mark module as completed - EXACT SwiftUI: UserDefaults.standard.set(true, forKey: "adv2_mod1")
        ...
        <View style={styles.mcqContainer}>
          {currentQuestion.options?.map((option, index) => (
            <MCQOptionButton
              ...
              forceCenter={false} // All options normal alignment
            />
          ))}
        </View>
      )
  ...
  return (
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        {/* Minimum score alert - EXACT SwiftUI: Adventure2Module1MinimumScoreAlertView */}
...
// Quiz Results View - EXACT SwiftUI Adventure2Module1QuizResultsView
...
const styles = StyleSheet.create({
  ...
  // Results View - EXACT SwiftUI Adventure2Module1QuizResultsView
  resultsContainer: {
    flex: 1,
