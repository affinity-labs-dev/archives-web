// Adventure4_Module3_Lesson2.tsx - Illuminated Manuscripts & Scribes Carousel
...
interface Adventure4_Module3_Lesson2Props {
  onContinue: () => void;
  onDismiss: () => void;
  onBack?: () => void;
}

export default function Adventure4_Module3_Lesson2({
  onContinue,
  onDismiss,
  onBack,
}: Adventure4_Module3_Lesson2Props) {
