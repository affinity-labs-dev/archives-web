...
export default function Adventure5_Module1_Lesson2({
  ...
  // Image metadata
  const imageTitle = "The court of Yazīd II became a place of tension and silence.";
  const imageDescription = "The peak of Umayyad cultural achievement where diverse traditions merged";

  // Content Structure for Educational Context
  const educationalContent = {
    moduleInfo: "Adventure 5 • Module 1 • Lesson 2",
    historicalContext: "Yazīd II's reign marked the peak of Umayyad cultural achievement, where diverse traditions merged into a distinctive Islamic aesthetic that would influence art and architecture for centuries to come. His court became a melting pot of Islamic, Byzantine, and Persian influences, creating an unprecedented synthesis of artistic traditions. The Caliph's patronage attracted the finest artists, architects, and scholars from across the empire, fostering innovation and cultural exchange that defined the golden age of Islamic civilization.",
    keyTerms: [
      {
        term: "Cultural Synthesis",
        definition: "The blending of Islamic, Byzantine, and Persian artistic traditions into a unified aesthetic"
      },
      {
        term: "Artistic Patronage",
        definition: "Royal support and funding for artists, architects, and scholars that enabled cultural flourishing"
      },
      {
        term: "Golden Age",
        definition: "Period of peak cultural achievement and artistic excellence under Umayyad rule"
      },
      {
        term: "Court Culture",
        definition: "The sophisticated cultural environment fostered by the Caliph's palace and administration"
      }
    ]
  };
  ...
  useEffect(() => {
    ...
    console.log(`🎵 [${timestamp}] Adventure5_Module1_Lesson2 - Background music state:`, {
  ...
  useEffect(() => {
    const timestamp = new Date().toLocaleTimeString();
    console.log('🎵 Adventure5_Module1_Lesson2 component mounted at:', timestamp);
  }, []);
