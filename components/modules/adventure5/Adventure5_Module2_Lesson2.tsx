// Adventure5_Module2_Lesson2.tsx - ImageCarouselLesson showcasing Abbasid symbols and propaganda
...
// Abbasid symbols and propaganda images
const abbasidSymbols = [
  {
    id: 1,
...
export default function Adventure5_Module2_Lesson2({
  ...
  const backgroundMusic = useBackgroundMusic(
    { uri: "https://dzyjrzj2lngmg.cloudfront.net/Audios/Adv5_M2_L2.mp3" },
    {
      volume: 0.5,
      shouldLoop: true,
    }
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        >
          {abbasidSymbols.map((symbol, index) => (
            <View key={symbol.id} style={styles.imageContainer}>
              <Image
