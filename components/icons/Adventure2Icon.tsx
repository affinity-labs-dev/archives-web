// Adventure2Icon.tsx - Custom SVG Icon for Adventure 2
import React from 'react'
import Svg, { Path } from 'react-native-svg'

interface Adventure2IconProps {
  size?: number
  color?: string
}

export default function Adventure2Icon({ size = 24, color = "#1f1f1f" }: Adventure2IconProps) {
  return (
    <Svg 
      width={size} 
      height={size} 
