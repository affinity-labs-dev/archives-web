...
// Image maps + getAchievementImage(id, unlocked) live in `./assetMaps`
// so ProfileAchievements (the preview row on the profile tab) can
// share the same locked/unlocked artwork instead of runtime grayscale.
