...
const ACHIEVEMENT_IMAGES: Record<string, any> = {
  perfect_scholar: require('@/assets/images/profile/achievements/achievement-perfect-scholar.png'),
  quiz_legend: require('@/assets/images/profile/achievements/achievement-quiz-legend.png'),
  quiz_master: require('@/assets/images/profile/achievements/achievement-quiz-master.png'),
  first_perfect: require('@/assets/images/profile/achievements/achievement-first-steps.png'),
  century_scholar: require('@/assets/images/profile/achievements/achievement-100-day-scholar.png'),
  quick_learner: require('@/assets/images/profile/achievements/achievement-quick-learner.png'),
  speed_demon: require('@/assets/images/profile/achievements/achievement-speed-demon.png'),
  week_warrior: require('@/assets/images/profile/achievements/achievement-week-warrior.png'),
  month_master: require('@/assets/images/profile/achievements/achievement-month-master.png'),
  early_bird: require('@/assets/images/profile/achievements/achievement-early-bird.png'),
  night_owl: require('@/assets/images/profile/achievements/achievement-night-owl.png'),
  era_complete_umayyad: require('@/assets/images/profile/achievements/achievement-umayyad-expert.png'),
  era_complete_women_of_islam: require('@/assets/images/profile/achievements/achievement-women-of-islam.png'),
  era_complete_roi: require('@/assets/images/profile/achievements/achievement-rise-of-islam.png'),
  xp_100: require('@/assets/images/profile/achievements/achievement-talib-seeker.png'),
  xp_250: require('@/assets/images/profile/achievements/achievement-daris-student.png'),
  xp_500: require('@/assets/images/profile/achievements/achievement-alim-scholar.png'),
  xp_1000: require('@/assets/images/profile/achievements/achievement-hakim-sage.png'),
  xp_2000: require('@/assets/images/profile/achievements/achievement-ustadh-master.png'),
  xp_3500: require('@/assets/images/profile/achievements/achievement-shaykh-al-ilm.png'),
};
