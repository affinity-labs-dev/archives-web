...
export default function ImageCarouselLesson({
  ...
  // Show continue hint when on last image (walkthrough check handled by useLessonBase)
  useEffect(() => {
        ...
        <View style={[styles.continueButtonContainer, { top: insets.top + 8 }]}>
          ...
          >
            <Ionicons
              ...
              size={24}
              color={
                currentImageIndex === images.length - 1 ? "white" : "#666"
              }
            />
          </TouchableOpacity>
        </View>
                    ...
                    >
                      <View style={styles.readingCardHeader}>
                        <Text style={styles.cardTitle}>
                          {contentItem.thumbnail_title || 'Image Gallery'}
                        </Text>
                          ...
                          <TouchableOpacity onPress={collapseCard} activeOpacity={0.9}>
                            <View style={styles.titleSection}>
                              ...
                              <Text style={styles.sheetSubtitle}>
                                Image Carousel • {contentItem.order_by}
                              </Text>
                            </View>
                          </TouchableOpacity>
